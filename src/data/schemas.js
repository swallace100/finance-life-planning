...
export const SCHEMAS = {
  ...
  RetirementSchedule: [
    ...
    {
      key: "AssetID",
      label: "Linked Account (leave blank for SS/pension)",
      type: "select",
      optionsFromData: (d) =>
        (d?.NonTangibleAssets || []).map((a) => ({
          value: a.ID,
  ...
  AssetGoals: [
    ...
    {
      key: "Subclass",
      label: "Subclass (blank = class-level goal)",
      type: "text",
    },
    {
      key: "GoalPct",
