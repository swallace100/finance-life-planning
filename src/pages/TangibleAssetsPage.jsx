...
export default function TangibleAssetsPage({ data, onSave, onDelete }) {
  ...
  return (
    <div className="space-y-6">
              ...
              <tbody>
                {applySort(rows).map(a => (
                  ...
                  >
                    ...
                    <td className="py-3 pr-4 text-slate-400">{a.Condition || '—'}</td>
      ...
      <Modal open={modal.open} onClose={modal.close} title={modal.isEditing ? 'Edit Tangible Asset' : 'Add Tangible Asset'}>
        <EntityForm
          schema={SCHEMAS.TangibleAssets}
