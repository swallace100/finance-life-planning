...
const SHEET_COLUMNS = {
  ...
  CryptoAssets:       ['ID', 'Name', 'Ticker', 'Wallet', 'Quantity', 'Value', 'Staked', 'AutoRestake', 'StakingAPY', 'UnlockDate', 'Notes'],
  ...
  Contacts:              ['ID', 'Name', 'Relationship', 'Phone', 'Email', 'Social', 'Address', 'Birthday', 'Favorite', 'Notes'],
